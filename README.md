...
* The first project Cross Course Project- RainyDays:
   ...
   In this project, translate a figma design into a functional web page using HTML, CSS.
* The second project JavaScript 1 project:
   GitHub link: https://github.com/Shefaa62/RainyDaysJavascript 
   This is an online store using JavaScript and API.
* The third Project PE/Exam project- an online store:
   GitHub link: https://github.com/Shefaa62/Exam-
